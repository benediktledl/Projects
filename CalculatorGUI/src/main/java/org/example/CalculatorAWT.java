...
class CalculatorAWT extends WindowAdapter implements ActionListener{
    Frame f;
    Label l1;
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==bcalc){
            try{
                ...
                l1.setText("Gebe zuerst eine Rechnung ein ");
                return;
            }
            if(check==1)
                xd =num1+num2;
